...
T = TypeVar("T", bound="AssetCriticalityMotor")


@_attrs_define
class AssetCriticalityMotor:
    name: str
    company_id: str
    sensitivity: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sensitivity: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_sensitivity(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        asset_criticality_motor.additional_properties = d
        return asset_criticality_motor
