...
T = TypeVar("T", bound="ApiSupplyItemCategory")


@_attrs_define
class ApiSupplyItemCategory:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_item_category.additional_properties = d
        return api_supply_item_category
