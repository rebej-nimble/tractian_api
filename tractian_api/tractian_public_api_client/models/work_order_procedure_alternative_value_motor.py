...
T = TypeVar("T", bound="WorkOrderProcedureAlternativeValueMotor")


@_attrs_define
class WorkOrderProcedureAlternativeValueMotor:
    value: "WorkOrderProcedureValueMotor"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        value = WorkOrderProcedureValueMotor.from_dict(d.pop("value"))
        ...
        work_order_procedure_alternative_value_motor = cls(
            value=value,
            level_id=level_id,
        )

        work_order_procedure_alternative_value_motor.additional_properties = d
        return work_order_procedure_alternative_value_motor
