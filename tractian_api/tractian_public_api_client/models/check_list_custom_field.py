...
T = TypeVar("T", bound="CheckListCustomField")


@_attrs_define
class CheckListCustomField:
    id_custom_field: str
    field_type: str
    value: list[int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_list_custom_field = cls(
            id_custom_field=id_custom_field,
            field_type=field_type,
            value=value,
        )

        check_list_custom_field.additional_properties = d
        return check_list_custom_field
