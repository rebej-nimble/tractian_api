...
T = TypeVar("T", bound="InspectionList")
...
class InspectionList:
    id: str
    name: str
    type_: Union[Unset, str] = "inspectionList"
    notes: Union[None, Unset, str] = UNSET
    value: Union[None, Unset, list["ActivityAlternativeValueMotor"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(
            data: object,
        ) -> Union[None, Unset, list["ActivityAlternativeValueMotor"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = ActivityAlternativeValueMotor.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["ActivityAlternativeValueMotor"]], data)
        ...
        inspection_list.additional_properties = d
