...
T = TypeVar("T", bound="WorkOrderOperationInventoryInventory")


@_attrs_define
class WorkOrderOperationInventoryInventory:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_order_operation_inventory_inventory = cls(
            id=id,
            identifier_code=identifier_code,
        )

        work_order_operation_inventory_inventory.additional_properties = d
        return work_order_operation_inventory_inventory
