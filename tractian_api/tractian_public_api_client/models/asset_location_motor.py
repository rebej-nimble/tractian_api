...
T = TypeVar("T", bound="AssetLocationMotor")


@_attrs_define
class AssetLocationMotor:
    id: str
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_location_motor.additional_properties = d
        return asset_location_motor
