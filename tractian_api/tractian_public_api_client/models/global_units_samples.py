...
T = TypeVar("T", bound="GlobalUnitsSamples")


@_attrs_define
class GlobalUnitsSamples:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_units_samples.additional_properties = d
        return global_units_samples
