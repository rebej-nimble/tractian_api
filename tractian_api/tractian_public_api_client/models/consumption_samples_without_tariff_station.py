...
T = TypeVar("T", bound="ConsumptionSamplesWithoutTariffStation")


@_attrs_define
class ConsumptionSamplesWithoutTariffStation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        consumption_samples_without_tariff_station = cls(
        ...
        consumption_samples_without_tariff_station.additional_properties = d
        return consumption_samples_without_tariff_station
