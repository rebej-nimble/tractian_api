...
T = TypeVar("T", bound="WorkOrderProcedureValueMotor")


@_attrs_define
class WorkOrderProcedureValueMotor:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_order_procedure_value_motor = cls(
            option=option,
        )

        work_order_procedure_value_motor.additional_properties = d
        return work_order_procedure_value_motor
