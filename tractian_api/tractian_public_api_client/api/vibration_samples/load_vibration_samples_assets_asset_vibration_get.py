...
def sync_detailed(
    ...
    *,
    ...
    vibration samples that meet specific criteria, such as whether the asset was powered on or if only
    specialist samples are required. Ensure that the asset ID is valid, and that the date range follows
    the ISO8601 format in UTC (e.g., `2023-05-01T03:00:00.000Z`).
    ...
    Args:
        ...
        powered (Union[Unset, bool]): Indicates if the asset was powered on during data
            collection. Defaults to `false`. Default: False.
        specialist (Union[Unset, bool]): If set to `true`, returns only samples collected by
