...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/assets/{asset}/energy/current",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Load Energy Current by Asset ID

     Fetches energy current data (A - Amperes) for a specified asset within a given date range. This
    endpoint provides energy current samples that meet specific criteria, such as whether the asset was
