...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/assets/{asset}/energy/reactive-power",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Load Energy Reactive Power by Asset ID

     Fetches energy reactive power data (VAR - Volt-amperes reactive) for a specified asset within a
    given date range. This endpoint provides energy reactive power samples that meet specific criteria,
    such as whether the asset was powered on or if only specialist samples are required. Ensure that the
    asset ID is valid, and that the date range follows the ISO8601 format in UTC (e.g.,
