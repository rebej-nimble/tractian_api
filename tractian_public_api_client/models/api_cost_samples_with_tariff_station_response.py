...
T = TypeVar("T", bound="ApiCostSamplesWithTariffStationResponse")


@_attrs_define
class ApiCostSamplesWithTariffStationResponse:
    company_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_cost_samples_with_tariff_station_response = cls(
        ...
        api_cost_samples_with_tariff_station_response.additional_properties = d
        return api_cost_samples_with_tariff_station_response
