...
T = TypeVar("T", bound="ApiLocationsRequest")


@_attrs_define
class ApiLocationsRequest:
    name: str
    company_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_locations_request.additional_properties = d
        return api_locations_request
