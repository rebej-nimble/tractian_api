...
T = TypeVar("T", bound="ApiDemandSamplesWithoutTariffStationResponse")


@_attrs_define
class ApiDemandSamplesWithoutTariffStationResponse:
    company_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_demand_samples_without_tariff_station_response = cls(
        ...
        api_demand_samples_without_tariff_station_response.additional_properties = d
        return api_demand_samples_without_tariff_station_response
