...
T = TypeVar("T", bound="ApiSupplyStorageLocationDeleted")


@_attrs_define
class ApiSupplyStorageLocationDeleted:
    value: Union[Unset, bool] = False
    """ Indicates whether the storage location has been deleted """
    reason: Union[None, Unset, str] = UNSET
    """ Reason for deleting the storage location """
    deleted_at: Union[None, Unset, str] = UNSET
    """ The date and time when the storage location was deleted """
    deleted_by_user_id: Union[None, Unset, str] = UNSET
    """ The id of the user who deleted the storage location """
    restored_by_user_id: Union[None, Unset, str] = UNSET
    """ The id of the user who restored the storage location """
    restored_at: Union[None, Unset, str] = UNSET
    """ The date and time when the storage location was restored """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_storage_location_deleted = cls(
            value=value,
            reason=reason,
        ...
        api_supply_storage_location_deleted.additional_properties = d
        return api_supply_storage_location_deleted
