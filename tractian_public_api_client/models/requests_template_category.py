...
T = TypeVar("T", bound="RequestsTemplateCategory")


@_attrs_define
class RequestsTemplateCategory:
    id: str
    name: str
    color: str
    company_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requests_template_category = cls(
            id=id,
            name=name,
            color=color,
        ...
        requests_template_category.additional_properties = d
        return requests_template_category
