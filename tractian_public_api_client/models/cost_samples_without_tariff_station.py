...
T = TypeVar("T", bound="CostSamplesWithoutTariffStation")


@_attrs_define
class CostSamplesWithoutTariffStation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_samples_without_tariff_station = cls(
            sampled_at=sampled_at,
            cost=cost,
            forecast=forecast,
        )

        cost_samples_without_tariff_station.additional_properties = d
        return cost_samples_without_tariff_station
