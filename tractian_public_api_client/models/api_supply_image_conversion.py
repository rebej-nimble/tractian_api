...
T = TypeVar("T", bound="ApiSupplyImageConversion")


@_attrs_define
class ApiSupplyImageConversion:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_image_conversion = cls(
            input_=input_,
            output=output,
        )

        api_supply_image_conversion.additional_properties = d
        return api_supply_image_conversion
