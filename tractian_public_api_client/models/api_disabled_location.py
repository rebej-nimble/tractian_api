...
T = TypeVar("T", bound="ApiDisabledLocation")


@_attrs_define
class ApiDisabledLocation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_disabled_location.additional_properties = d
        return api_disabled_location
