...
T = TypeVar("T", bound="ApiConsumptionSamplesWithTariffStationResponse")


@_attrs_define
class ApiConsumptionSamplesWithTariffStationResponse:
    company_id: str
    """ Company ID """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_consumption_samples_with_tariff_station_response = cls(
        ...
        api_consumption_samples_with_tariff_station_response.additional_properties = d
        return api_consumption_samples_with_tariff_station_response
