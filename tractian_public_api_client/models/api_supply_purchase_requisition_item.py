...
T = TypeVar("T", bound="ApiSupplyPurchaseRequisitionItem")


@_attrs_define
class ApiSupplyPurchaseRequisitionItem:
    id: str
    ...
    requested_quantity: Union[None, Unset, float] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        requested_quantity: Union[None, Unset, float]
        if isinstance(self.requested_quantity, Unset):
            requested_quantity = UNSET
        else:
        ...
        if requested_quantity is not UNSET:
            field_dict["requestedQuantity"] = requested_quantity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_requested_quantity(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        api_supply_purchase_requisition_item = cls(
            id=id,
            number=number,
        ...
        api_supply_purchase_requisition_item.additional_properties = d
        return api_supply_purchase_requisition_item
