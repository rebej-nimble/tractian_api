...
T = TypeVar("T", bound="ApiSupplyReservationPutRequest")


@_attrs_define
class ApiSupplyReservationPutRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_reservation_put_request = cls(
            canceled=canceled,
        ...
        api_supply_reservation_put_request.additional_properties = d
        return api_supply_reservation_put_request
