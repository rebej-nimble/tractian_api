...
T = TypeVar("T", bound="MetricsFieldValues")


@_attrs_define
class MetricsFieldValues:
    id: str
    type_: str
    name: str
    metric_id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metrics_field_values.additional_properties = d
        return metrics_field_values
