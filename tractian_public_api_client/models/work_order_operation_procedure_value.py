...
T = TypeVar("T", bound="WorkOrderOperationProcedureValue")


@_attrs_define
class WorkOrderOperationProcedureValue:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_order_operation_procedure_value = cls(
            option=option,
        )

        work_order_operation_procedure_value.additional_properties = d
        return work_order_operation_procedure_value
