...
T = TypeVar("T", bound="ApiSupplyPurchaseRequestAction")


@_attrs_define
class ApiSupplyPurchaseRequestAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_purchase_request_action = cls(
            purchase_requisition_ids=purchase_requisition_ids,
            company_id=company_id,
        )

        api_supply_purchase_request_action.additional_properties = d
        return api_supply_purchase_request_action
