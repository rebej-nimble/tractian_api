...
T = TypeVar("T", bound="ApiSupplyMeasurementUnitPutRequest")


@_attrs_define
class ApiSupplyMeasurementUnitPutRequest:
    company_id: str
    name: str
    plural: str
    abbreviation: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_measurement_unit_put_request = cls(
        ...
        api_supply_measurement_unit_put_request.additional_properties = d
        return api_supply_measurement_unit_put_request
