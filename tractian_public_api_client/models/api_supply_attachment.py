...
if TYPE_CHECKING:
    from ..models.api_supply_deleted import ApiSupplyDeleted


T = TypeVar("T", bound="ApiSupplyAttachment")


@_attrs_define
class ApiSupplyAttachment:
    id: str
    ...
    deleted: Union[Unset, "ApiSupplyDeleted"] = UNSET
    ...
    size: Union[None, Unset, float, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        size: Union[None, Unset, float, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, ApiSupplyDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = ApiSupplyDeleted.from_dict(_deleted)
        ...
        def _parse_size(data: object) -> Union[None, Unset, float, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        api_supply_attachment.additional_properties = d
        return api_supply_attachment
