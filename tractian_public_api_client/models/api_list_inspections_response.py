...
if TYPE_CHECKING:
    from ..models.api_list_inspections_procedure import ApiListInspectionsProcedure
    from ..models.simplified_prescription import SimplifiedPrescription


T = TypeVar("T", bound="ApiListInspectionsResponse")


@_attrs_define
class ApiListInspectionsResponse:
    company_id: str
    title: str
    status: str
    created_at: str
    ...
    procedures: Union[None, Unset, list["ApiListInspectionsProcedure"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_procedures(
            data: object,
        ) -> Union[None, Unset, list["ApiListInspectionsProcedure"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for procedures_type_0_item_data in _procedures_type_0:
                    procedures_type_0_item = ApiListInspectionsProcedure.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["ApiListInspectionsProcedure"]], data)
        ...
        api_list_inspections_response = cls(
        ...
        api_list_inspections_response.additional_properties = d
        return api_list_inspections_response
