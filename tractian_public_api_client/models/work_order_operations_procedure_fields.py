...
T = TypeVar("T", bound="WorkOrderOperationsProcedureFields")


@_attrs_define
class WorkOrderOperationsProcedureFields:
    name: str
    type_: str
    value: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        work_order_operations_procedure_fields = cls(
            name=name,
            type_=type_,
            value=value,
        )

        work_order_operations_procedure_fields.additional_properties = d
        return work_order_operations_procedure_fields
