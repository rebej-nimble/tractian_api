...
T = TypeVar("T", bound="ApiSupplyMeasurementUnitRequest")


@_attrs_define
class ApiSupplyMeasurementUnitRequest:
    company_id: str
    name: str
    plural: str
    abbreviation: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_measurement_unit_request = cls(
        ...
        api_supply_measurement_unit_request.additional_properties = d
        return api_supply_measurement_unit_request
