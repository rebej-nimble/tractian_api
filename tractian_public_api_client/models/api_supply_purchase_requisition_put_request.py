...
T = TypeVar("T", bound="ApiSupplyPurchaseRequisitionPutRequest")


@_attrs_define
class ApiSupplyPurchaseRequisitionPutRequest:
    id: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_supply_purchase_requisition_put_request = cls(
            id=id,
        ...
        api_supply_purchase_requisition_put_request.additional_properties = d
        return api_supply_purchase_requisition_put_request
