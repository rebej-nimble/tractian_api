...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/assets/{asset}/energy/power-factor",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Load Energy Power Factor by Asset ID

     Fetches energy power factor data for a specified asset within a given date range. This endpoint
    provides energy power factor samples that meet specific criteria, such as whether the asset was
