...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/assets/{asset}/energy/voltage",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Load Energy Voltage by Asset ID

     Fetches energy voltage data (V - Volts) for a specified asset within a given date range. This
    endpoint provides energy voltage samples that meet specific criteria, such as whether the asset was
