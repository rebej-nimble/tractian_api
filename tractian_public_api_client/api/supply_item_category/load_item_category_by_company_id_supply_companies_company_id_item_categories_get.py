...
from ...models.pagination_api_supply_item_category_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/supply/companies/{company_id}/item-categories",
        "params": params,
    }
...
) -> Optional[Union[HTTPValidationError, PaginationApiSupplyItemCategoryResponse]]:
    if response.status_code == 200:
        response_200 = PaginationApiSupplyItemCategoryResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, PaginationApiSupplyItemCategoryResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Load Item Category By Company Id

     Load item categories by company id.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, PaginationApiSupplyItemCategoryResponse]
    """
